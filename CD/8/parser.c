...
{
       5,     6,    13,    14,    12,    13,    14,    17,     7,    15,
      16,     1,    18,    19,     3,     4,    20,    21,    11
};

static const yytype_int8 yycheck[] =
{
       3,     4,     7,     8,     6,     7,     8,    12,    11,     9,
      10,     3,    13,    14,     5,     0,    15,    16,     7
};
...
{
       0,     3,    14,     5,     0,     3,     4,    11,    15,    16,
      17,    15,     6,     7,     8,     9,    10,    12,    16,    16,
      17,    17
};
...
#line 1083 "parser.c"
  ...
  case 3: /* E: E '+' T  */
#line 24 "parser.y"
            { (yyval.node) = newNode('E','+',(yyvsp[-2].node),(yyvsp[0].node),0); }
#line 1089 "parser.c"
    break;
...
#line 1101 "parser.c"
  ...
  case 6: /* T: T '*' F  */
#line 29 "parser.y"
            { (yyval.node) = newNode('T','*',(yyvsp[-2].node),(yyvsp[0].node),0); }
#line 1107 "parser.c"
    break;
